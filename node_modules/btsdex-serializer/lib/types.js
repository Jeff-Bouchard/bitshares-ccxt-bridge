...
Types.time_point_sec = {
  ...
  toObject(object, debug = {}) {
    ...
    _SerializerValidation.default.require_range(0, 0xffffffff, int, `uint32 ${object}`);
...
Types.extension = function (fields_def) {
  ...
  _SerializerValidation.default.require_array(fields_def, r => {
  ...
  return {
    ...
    appendByteBuffer(b, object) {
      ...
      let tempBuffer = new _bytebuffer.default(_bytebuffer.default.DEFAULT_CAPACITY, _bytebuffer.default.LITTLE_ENDIAN);
      var count = 0;
...
Types.public_key = {
  toPublic(object) {
    ...
    return object == null ? object : object.Q ? object : _btsdexEcc.PublicKey.fromStringOrThrow(object);
  },
  ...
  toObject(object, debug = {}) {
    if (debug.use_default && object === undefined) {
      return (0, _btsdexEcc.getAddressPrefix)() + "859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM";
    }
...
Types.address = {
  _to_address(object) {
    ...
    return _btsdexEcc.Address.fromString(object);
  },

  fromByteBuffer(b) {
    return new _btsdexEcc.Address(_FastParser.default.ripemd160(b));
  },
  ...
  toObject(object, debug = {}) {
    if (debug.use_default && object === undefined) {
      return (0, _btsdexEcc.getAddressPrefix)() + "664KmHxSuQyDsfwo4WEJvWpzg1QKdg67S";
    }
...
let sortOperation = (array, st_operation) => st_operation.nosort ? array : st_operation.compare ? array.sort((a, b) => st_operation.compare(firstEl(a), firstEl(b))) // custom compare operation
: array.sort((a, b) => typeof firstEl(a) === "number" && typeof firstEl(b) === "number" ? firstEl(a) - firstEl(b) : // A binary string compare does not work. Performanance is very good so HEX is used..  localeCompare is another option.
