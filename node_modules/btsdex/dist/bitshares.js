...
/*#__PURE__*/
function () {
  (0, _createClass2.default)(BitShares, null, [{
    key: "connect",
    value: function () {
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                autoreconnect = _args.length > 1 && _args[1] !== undefined ? _args[1] : BitShares.autoreconnect;
                ...
                return _context.abrupt("return", Promise.all([BitShares.connectPromise, BitShares.connectedPromise]));

              case 3:
                if (autoreconnect) _api.default.getApis().setRpcConnectionStatusCallback(BitShares.statusCallBack);
                _context.next = 6;
                return BitShares.connectPromise = BitShares.reconnect(node);

              case 6:
                _context.next = 8;
                return BitShares.connectedPromise = BitShares.connectedInit();
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                node = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : BitShares.node;
                _context2.next = 3;
    ...
    key: "connectedInit",
    value: function () {
      var _connectedInit = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee4(accountName, password) {
        var feeSymbol,
            acc,
            activeKey,
            genPubKey,
        ...
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                feeSymbol = _args4.length > 2 && _args4[2] !== undefined ? _args4[2] : BitShares.chain.core_asset;
                _context4.next = 3;
                return BitShares.accounts[accountName];

              case 3:
                acc = _context4.sent;
                activeKey = _bitsharesjs.PrivateKey.fromSeed("".concat(accountName, "active").concat(password));
              ...
              case 8:
                account = new BitShares(accountName, activeKey.toWif(), feeSymbol);
                account.setMemoKey((acc.options.memo_key === genPubKey ? activeKey : _bitsharesjs.PrivateKey.fromSeed("".concat(accountName, "memo").concat(password))).toWif());
                _context4.next = 12;
    ...
    key: "loginFromFile",
    value: function () {
      var _loginFromFile = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee5(buffer, password, accountName) {
        var feeSymbol,
            backup_buffer,
            buffer_data,
            wallet,
        ...
        return _regenerator.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                feeSymbol = _args5.length > 3 && _args5[3] !== undefined ? _args5[3] : BitShares.chain.core_asset;
                backup_buffer = _bitsharesjs.Aes.decrypt_with_checksum(_bitsharesjs.PrivateKey.fromSeed(password), _bitsharesjs.PublicKey.fromBuffer(buffer.slice(0, 33)), null
                /*nonce*/
                , buffer.slice(33));
                buffer_data = JSON.parse(_lzmaDMin.LZMA.decompress(backup_buffer)), wallet = buffer_data.wallet[0], password_aes = _bitsharesjs.Aes.fromSeed(password), encryption_plainbuffer = password_aes.decryptHexToBuffer(wallet.encryption_key), aes_private = _bitsharesjs.Aes.fromSeed(encryption_plainbuffer);
                _context5.next = 5;
                return BitShares.accounts[accountName];
              ...
              case 9:
                ...
                activeKey = _bitsharesjs.PrivateKey.fromBuffer(new Buffer(private_key_hex, "hex"));
                account = new BitShares(accountName, activeKey.toWif(), feeSymbol);
      ...
      return function loginFromFile(_x4, _x5, _x6) {
    ...
    key: "tradeHistory",
    value: function () {
      var _tradeHistory = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee6(quoteSymbol, baseSymbol, startDate, stopDate, bucketSeconds) {
        return _regenerator.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.t0 = BitShares.history;
                _context6.next = 3;
                return BitShares.assets[quoteSymbol];

              case 3:
                _context6.t1 = _context6.sent.id;
                _context6.next = 6;
                return BitShares.assets[baseSymbol];
      ...
      return function tradeHistory(_x7, _x8, _x9, _x10, _x11) {
    ...
    key: "getLimitOrders",
    value: function () {
      var _getLimitOrders = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee7(quoteSymbol, baseSymbol) {
        var limit,
            _args7 = arguments;
      ...
      return function getLimitOrders(_x12, _x13) {
    ...
    key: "getOrderBook",
    value: function () {
      var _getOrderBook = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee8(quoteSymbol, baseSymbol) {
        var limit,
            _args8 = arguments;
      ...
      return function getOrderBook(_x14, _x15) {
        return _getOrderBook.apply(this, arguments);
      };
    }()
  }]);

  function BitShares(accountName, activeKey) {
    var _this = this;

    var _feeSymbol = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : BitShares.chain.core_asset;

    (0, _classCallCheck2.default)(this, BitShares);
    (0, _defineProperty2.default)(this, "setFeeAsset",
    /*#__PURE__*/
    function () {
      var _ref = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee9(feeSymbol) {
        return _regenerator.default.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 2:
                _context9.next = 4;
                return BitShares.assets[feeSymbol];
    ...
    (0, _defineProperty2.default)(this, "setMemoKey", function (memoKey) {
      _this.memoKey = _bitsharesjs.PrivateKey.fromWif(memoKey);
    });
    ...
    (0, _defineProperty2.default)(this, "balances",
    /*#__PURE__*/
          ...
          switch (_context11.prev = _context11.next) {
            ...
            case 2:
              ...
              function () {
                ...
                /*#__PURE__*/
                _regenerator.default.mark(function _callee10(asset) {
                  return _regenerator.default.wrap(function _callee10$(_context10) {
                    while (1) {
                      switch (_context10.prev = _context10.next) {
                        case 0:
                          _context10.next = 2;
                          return BitShares.assets[asset];
            ...
            case 5:
              ...
              _context11.next = 8;
              return BitShares.db.get_account_balances(_this.account.id, assets);

            case 8:
              balances = _context11.sent;
              return _context11.abrupt("return", Promise.all(balances.map(function (balance) {
                return BitShares.assets.fromParam(balance);
              })));
    ...
    (0, _defineProperty2.default)(this, "buyOperation",
    /*#__PURE__*/
    function () {
      var _ref4 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee12(buySymbol, baseSymbol, amount, price) {
        var fill_or_kill,
            expire,
            buyAsset,
            baseAsset,
        ...
        return _regenerator.default.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 4:
                _context12.next = 6;
                return BitShares.assets[buySymbol];
    ...
    (0, _defineProperty2.default)(this, "buy",
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 6:
              tx = _context13.sent;
              _context13.next = 9;
              return BitShares.db.get_objects([tx[0].trx.operation_results[0][1]]);
    ...
    (0, _defineProperty2.default)(this, "sellOperation",
    /*#__PURE__*/
    function () {
      var _ref6 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee14(sellSymbol, baseSymbol, amount, price) {
        var fill_or_kill,
            expire,
            sellAsset,
            baseAsset,
        ...
        return _regenerator.default.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              ...
              case 4:
                _context14.next = 6;
                return BitShares.assets[sellSymbol];
    ...
    (0, _defineProperty2.default)(this, "sell",
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
      ...
      return _regenerator.default.wrap(function _callee16$(_context16) {
        while (1) {
          switch (_context16.prev = _context16.next) {
            ...
            case 2:
              _context16.next = 4;
              return BitShares.db.get_full_accounts([_this.account.id], false);
    ...
    (0, _defineProperty2.default)(this, "getOrder",
    /*#__PURE__*/
    function () {
        ...
        return _regenerator.default.wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              ...
              case 2:
                _context17.next = 4;
                return BitShares.db.get_objects([id]);
    ...
    (0, _defineProperty2.default)(this, "cancelOrderOperation",
    /*#__PURE__*/
    function () {
    ...
    (0, _defineProperty2.default)(this, "cancelOrder",
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
    ...
    (0, _defineProperty2.default)(this, "memo",
    /*#__PURE__*/
    function () {
      var _ref12 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee20(toName, message) {
        var nonce, to;
          ...
          while (1) {
            switch (_context20.prev = _context20.next) {
              ...
              case 2:
                ...
                _context20.next = 5;
                return BitShares.accounts[toName];
              ...
              case 5:
                ...
                return _context20.abrupt("return", {
                  ...
                  to: to,
                  nonce: nonce,
                  message: _bitsharesjs.Aes.encrypt_with_checksum(_this.memoKey, to, nonce, new Buffer(message, "utf-8"))
                });
    ...
    (0, _defineProperty2.default)(this, "memoDecode", function (memos) {
      ...
      return _bitsharesjs.Aes.decrypt_with_checksum(_this.memoKey, memos.from, memos.nonce, memos.message).toString("utf-8");
    });
    (0, _defineProperty2.default)(this, "transferOperation",
    /*#__PURE__*/
    function () {
      var _ref13 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee21(toName, assetSymbol, amount, memo) {
        ...
        return _regenerator.default.wrap(function _callee21$(_context21) {
          while (1) {
            switch (_context21.prev = _context21.next) {
              ...
              case 2:
                _context21.next = 4;
                return BitShares.assets[assetSymbol];
    ...
    (0, _defineProperty2.default)(this, "transfer",
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
    ...
    (0, _defineProperty2.default)(this, "assetIssueOperation",
    /*#__PURE__*/
    function () {
      var _ref15 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee23(toName, assetSymbol, amount, memo) {
        var asset, intAmount, params;
    ...
    (0, _defineProperty2.default)(this, "assetIssue",
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
    ...
    (0, _defineProperty2.default)(this, "assetReserveOperation",
    /*#__PURE__*/
    function () {
      var _ref17 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee25(assetSymbol, amount) {
    ...
    (0, _defineProperty2.default)(this, "assetReserve",
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
    ...
    this.initPromise = Promise.all([BitShares.accounts[accountName], BitShares.assets[_feeSymbol]]).then(function (params) {
