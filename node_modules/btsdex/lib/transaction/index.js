...
class Transaction {
  ...
  constructor(_keys) {
    ...
    (0, _defineProperty2.default)(this, "sign", async keys => {
    ...
    (0, _defineProperty2.default)(this, "cost", async () => {
      ...
      let assets = await _btsdexApi.database.getAssets(Object.keys(fees)); //return assets.map(asset => ({asset, amount: fees[asset.id] / 10 ** asset.precision}))
    ...
    this.tx = new _TransactionBuilder.default();
    this.keys = _keys;
  }
